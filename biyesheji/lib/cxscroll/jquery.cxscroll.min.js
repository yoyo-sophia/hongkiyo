...
!function(a) {
    ...
    a.cxScroll = function() {
        ...
        e.build = function() {
            var b = this;
            if (b.dom.box = b.dom.el.find(".box"),
            b.dom.list = b.dom.box.find(".list"),
            b.dom.items = b.dom.list.find(".list_item"),
            b.itemSum = b.dom.items.length,
            !(b.itemSum <= 1)) {
                if (b.dom.prevBtn = b.dom.el.find(".prev"),
                b.dom.nextBtn = b.dom.el.find(".next"),
                b.itemWidth = b.dom.items.outerWidth(),
                b.itemHeight = b.dom.items.outerHeight(),
                "left" === b.settings.direction || "right" === b.settings.direction) {
                ...
                b.settings.prevBtn && !b.dom.prevBtn.length && (b.dom.prevBtn = a("<a></a>", {
                    "class": "prev"
                }).prependTo(b.dom.el)),
                b.settings.nextBtn && !b.dom.nextBtn.length && (b.dom.nextBtn = a("<a></a>", {
                    "class": "next"
                }).prependTo(b.dom.el)),
                b.settings.nextBtn && b.dom.nextBtn.length && b.dom.nextBtn.bind("click", function() {
        ...
        e.play = function() {
            var a = this;
            a.settings.auto && (a.stop(),
            a.run = setTimeout(function() {
                a.goto()
            }, a.settings.time))
        }
        ,
        ...
        ,
        e.goto = function(b, c) {
            var e, f, d = this, g = c || d.settings.speed;
            switch ("string" != typeof b && (b = d.settings.direction),
            d.stop(),
            d.lockState = !0,
            b) {
            case "left":
            case "top":
                e = 0,
                "left" === b ? (0 === parseInt(d.dom.box.scrollLeft(), 10) && d.dom.box.scrollLeft(d.itemSum * d.moveVal),
                f = d.dom.box.scrollLeft() - d.moveVal * d.settings.step,
                f % d.itemWidth > 0 && (f -= f % d.itemWidth - d.itemWidth),
                e > f && (f = e),
                d.dom.box.animate({
                    scrollLeft: f
                }, g, d.settings.easing, function() {
                    parseInt(d.dom.box.scrollLeft(), 10) <= e && d.dom.box.scrollLeft(0)
                })) : (0 === parseInt(d.dom.box.scrollTop(), 10) && d.dom.box.scrollTop(d.itemSum * d.moveVal),
                f = d.dom.box.scrollTop() - d.moveVal * d.settings.step,
                f % d.itemHeight > 0 && (f -= f % d.itemHeight - d.itemHeight),
                e > f && (f = e),
                d.dom.box.animate({
                    scrollTop: f
                }, g, d.settings.easing, function() {
            ...
            case "bottom":
                ...
                "right" === b ? (f = d.dom.box.scrollLeft() + d.moveVal * d.settings.step,
                f % d.itemWidth > 0 && (f -= f % d.itemWidth),
                f > e && (f = e),
                d.dom.box.animate({
                    scrollLeft: f
                }, g, d.settings.easing, function() {
                ...
                f % d.itemHeight > 0 && (f -= f % d.itemHeight),
                f > e && (f = e),
                d.dom.box.animate({
                    scrollTop: f
                }, g, d.settings.easing, function() {
